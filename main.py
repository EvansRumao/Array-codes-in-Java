...
#we use uvicorn to run the server 
#how to start the server run the command uvicorn main:app --reload
#uviron the acutal server thing main is the file name app is the app which is in the main file and reload is autorefresh after any changes
